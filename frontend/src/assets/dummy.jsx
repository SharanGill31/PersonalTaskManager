...
sidebar: "p-4 h-full bg-gray-100"
};
...
export const TI_CLASSES = {
    ...
    completeBtn: "mt-0.5 sm:mt-1 p-1 sm:p-1.5 rounded-full hover:bg-purple-100 transition-colors duration-300 opacity-100",
...
// APP.JSX
const user = {
    avatar: `https://ui-avatars.com/api/?name=${encodeURIComponent('Default User')}&background=random`
};