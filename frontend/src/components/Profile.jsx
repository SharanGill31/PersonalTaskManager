...
import { BACK_BUTTON, DANGER_BTN, FULL_BUTTON, SECTION_WRAPPER, securityFields } from '../assets/dummy';
import { ChevronLeft, Lock, LogOut, Shield, UserCircle } from 'lucide-react';
...
const Profile = ({ setCurrentUser, OnLogout }) => {
  ...
  const changePassword = async (e) => {
    e.preventDefault()
    if (passwords.new !== passwords.confirm) { // Corrected: Compare passwords.new with passwords.confirm
        ...
        <div className='grid md:grid-cols-2 gap-8'>
          <section className={SECTION_WRAPPER}>
            ...
            <form onSubmit={saveProfile} className='space-y-4'>
              ...
              <button
                type="submit"
                className='bg-gradient-to-r from-fuchsia-500 to-purple-600 text-white font-semibold rounded-md py-2 px-4 shadow-md hover:bg-gradient-to-l focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 transition duration-300 ease-in-out'
              >
                <Save className='w-35 h-5 mr-2 inline-block' /> Save Changes
              </button>
            </form>
          </section>
          ...
          <section className={SECTION_WRAPPER}>
            ...
            <form onSubmit={changePassword} className='space-y-4'>
             ...
             <button
  type='submit'
  className='bg-gradient-to-r from-fuchsia-500 to-purple-600 text-white font-semibold rounded-md py-2 px-4 shadow-md hover:bg-gradient-to-l focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 transition duration-300 ease-in-out  mx-auto block'
>
  <Shield className='w-4 h-4 mr-2 inline-block' /> Change Password
</button>
